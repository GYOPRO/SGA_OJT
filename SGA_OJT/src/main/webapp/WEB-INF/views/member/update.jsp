...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet"
	href="<c:url value='resources/css/tailwind.output.css'/>">
<script
          	...
          	<div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
            	<div class="w-full overflow-x-auto">
					<table class="w-full whitespace-no-wrap">
            	      ...
            	      <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800" id="memberList" style="position: resize: ;">
